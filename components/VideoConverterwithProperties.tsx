...
export default function VideoProperties ({
  ...
  function parseProgressAndDuration (message: string) {
  ...
  const load = async () => {
    ...
    try {
      const ffmpegLoaded = await ffmpeg.load(coreConfig)
      if (ffmpegLoaded){
          ...
          <div className='mt-4 grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 xl:gap-14 lg:gap-12 md:gap-8 gap-6 items-center'>
            <div className='flex flex-col'>
              ...
              // biome-ignore lint/suspicious/noExplicitAny: <explanation>
                onValueChange={(value: string | any) => setResolution(value)}
              >
            ...
            <div className='flex flex-col'>
              ...
              <Select
                // biome-ignore lint/suspicious/noExplicitAny: <explanation>
                onValueChange={(value: string | any) => setAspectRatio(value)}
              >
                <SelectTrigger id='fit'>
                  <SelectValue placeholder='Unchanged' />
                </SelectTrigger>
            ...
            <div className='flex flex-col'>
              ...
              <Select
                // biome-ignore lint/suspicious/noExplicitAny: <explanation>
                onValueChange={(value: string | any) => setFrameRate(value)}
              >
        ...
        <div className={`${converting && inputFile ? 'blur disabled' : ''}`}>
          ...
          <div className='mt-4 grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 xl:gap-14 lg:gap-12 md:gap-8 gap-6 items-center'>
            <div className='flex flex-col'>
              ...
              <Select
              // biome-ignore lint/suspicious/noExplicitAny: <explanation>
                onValueChange={(value: string | any) => setAudioCodec(value)}
              >
            ...
            <div className='flex flex-col'>
              ...
              <Select
              // biome-ignore lint/suspicious/noExplicitAny: <explanation>
                onValueChange={(value: string | any) => setChannels(value)}
              >
            ...
            <div className='flex flex-col'>
              ...
              <Select
              // biome-ignore lint/suspicious/noExplicitAny: <explanation>
                onValueChange={(value: string | any) => setSampleRate(value)}
              >
